...
void CFiguras::cuartoInt(GLuint text, GLuint text2, GLuint text3, GLuint text4) {
	GLfloat vertice[8][3] = {
	...
	glTexCoord2f(15, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(15, 3); glVertex3fv(vertice[4]);
	glTexCoord2f(0, 3); glVertex3fv(vertice[7]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(-1, 0, 0);
	glTexCoord2f(0, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(15, 0); glVertex3fv(vertice[3]);
	glTexCoord2f(15, 3); glVertex3fv(vertice[5]);
	glTexCoord2f(0, 3); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0, 0, 1);
	glTexCoord2f(0, 0); glVertex3fv(vertice[3]);
	glTexCoord2f(15, 0); glVertex3fv(vertice[2]);
	glTexCoord2f(15, 3); glVertex3fv(vertice[6]);
	glTexCoord2f(0, 3); glVertex3fv(vertice[5]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(1, 0, 0);
	glTexCoord2f(0, 0); glVertex3fv(vertice[2]);
	glTexCoord2f(15, 0); glVertex3fv(vertice[1]);
	glTexCoord2f(15, 3); glVertex3fv(vertice[7]);
	glTexCoord2f(0, 3); glVertex3fv(vertice[6]);
	glEnd();
	...
	glNormal3f(0, 1, 0);
	glTexCoord2f(0, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(7, 0); glVertex3fv(vertice[1]);
	glTexCoord2f(7, 5); glVertex3fv(vertice[2]);
	glTexCoord2f(0, 5); glVertex3fv(vertice[3]);
	glEnd();
	...
	glTexCoord2f(7, 0); glVertex3fv(vertice[4]);
	glTexCoord2f(7, 5); glVertex3fv(vertice[5]);
	glTexCoord2f(0, 5); glVertex3fv(vertice[6]);
	glEnd();
}
...
void CFiguras::piezaJenga(GLuint text) {
	GLfloat vertice[8][3] = {
		{ 0.06 ,-0.01, 0.02 },    //Coordenadas Vértice 0 V0
		{ -0.06 ,-0.01, 0.02 },    //Coordenadas Vértice 1 V1
		{ -0.06 ,-0.01, -0.02 },    //Coordenadas Vértice 2 V2
		{ 0.06 ,-0.01, -0.02 },    //Coordenadas Vértice 3 V3
		{ 0.06 ,0.01, 0.02 },    //Coordenadas Vértice 4 V4
		{ 0.06 ,0.01, -0.02 },    //Coordenadas Vértice 5 V5
		{ -0.06 ,0.01, -0.02 },    //Coordenadas Vértice 6 V6
		{ -0.06 ,0.01, 0.02 },    //Coordenadas Vértice 7 V7
	};
	...
	glBegin(GL_POLYGON);	//Front
	glNormal3f(0, 0, 1);
	glTexCoord2f(0, 0.32915); glVertex3fv(vertice[1]);
	glTexCoord2f(1, 0.32915); glVertex3fv(vertice[0]);
	glTexCoord2f(1, 0.4942); glVertex3fv(vertice[4]);
	glTexCoord2f(0, 0.4942); glVertex3fv(vertice[7]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
	glNormal3f(1, 0, 0);
	glTexCoord2f(0, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(0.333, 0); glVertex3fv(vertice[3]);
	glTexCoord2f(0.333, 0.166); glVertex3fv(vertice[5]);
	glTexCoord2f(0, 0.166); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0, 0, -1);
	glTexCoord2f(1, 0.32915); glVertex3fv(vertice[3]);
	glTexCoord2f(0, 0.32915); glVertex3fv(vertice[2]);
	glTexCoord2f(0, 0.166); glVertex3fv(vertice[6]);
	glTexCoord2f(1, 0.166); glVertex3fv(vertice[5]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(-1, 0, 0);
	glTexCoord2f(0.333, 0); glVertex3fv(vertice[2]);
	glTexCoord2f(0.666, 0); glVertex3fv(vertice[1]);
	glTexCoord2f(0.666, 0.166); glVertex3fv(vertice[7]);
	glTexCoord2f(0.333, 0.166); glVertex3fv(vertice[6]);
	glEnd();

	glBegin(GL_POLYGON);  //Bottom
	glNormal3f(0, -1, 0);
	glTexCoord2f(0, 0.7471); glVertex3fv(vertice[0]);
	glTexCoord2f(1, 0.7471); glVertex3fv(vertice[1]);
	...
	glTexCoord2f(0, 0.4942); glVertex3fv(vertice[7]);
	glTexCoord2f(1, 0.4942); glVertex3fv(vertice[4]);
	glTexCoord2f(1, 0.7471); glVertex3fv(vertice[5]);
	glTexCoord2f(0, 0.7471); glVertex3fv(vertice[6]);
	glEnd();
}

void CFiguras::planoSolid(GLfloat text) {
	GLfloat vertice[4][3] = {
		{ -0.5, -0.5, 0 },
		{ 0.5, -0.5, 0 },
		{ 0.5, 0.5, 0 },
...
void CFiguras::planoTrans(GLfloat text) {
	GLfloat vertice[4][3] = {
		{ -0.5, -0.5, 0 },
		{ 0.5, -0.5, 0 },
		{ 0.5, 0.5, 0 },
...
void CFiguras::planoAnim3(GLuint text) {
	GLfloat vertice[4][3] = {
		{ -0.5 , -0.5, 0 },    //Coordenadas Vértice 0 V0
		{ 0.5 , -0.5, 0 },    //Coordenadas Vértice 1 V1
		{ 0.5 , 0.5, 0 },    //Coordenadas Vértice 2 V2
		{ -0.5 , 0.5, 0 },    //Coordenadas Vértice 3 V3
	};
	glBindTexture(GL_TEXTURE_2D, text);
	glBegin(GL_POLYGON);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(tizq3, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(tder3, 0); glVertex3fv(vertice[1]);
	glTexCoord2f(tder3, 1); glVertex3fv(vertice[2]);
	glTexCoord2f(tizq3, 1); glVertex3fv(vertice[3]);
	glEnd();
}

void CFiguras::planoAnim5(GLuint text) {
	GLfloat vertice[4][3] = {
		{ -0.5 , -0.5, 0 },    //Coordenadas Vértice 0 V0
		{ 0.5 , -0.5, 0 },    //Coordenadas Vértice 1 V1
		{ 0.5 , 0.5, 0 },    //Coordenadas Vértice 2 V2
	...
	glBegin(GL_POLYGON);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(tizq5, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(tder5, 0); glVertex3fv(vertice[1]);
	glTexCoord2f(tder5, 1); glVertex3fv(vertice[2]);
	glTexCoord2f(tizq5, 1); glVertex3fv(vertice[3]);
	glEnd();
}

void CFiguras::planoAnim12(GLuint text) {
	GLfloat vertice[4][3] = {
		{ -0.5 , -0.5, 0 },    //Coordenadas Vértice 0 V0
		{ 0.5 , -0.5, 0 },    //Coordenadas Vértice 1 V1
		{ 0.5 , 0.5, 0 },    //Coordenadas Vértice 2 V2
	...
	glBegin(GL_POLYGON);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(tizq12, 0); glVertex3fv(vertice[0]);
	glTexCoord2f(tder12, 0); glVertex3fv(vertice[1]);
	glTexCoord2f(tder12, 1); glVertex3fv(vertice[2]);
	glTexCoord2f(tizq12, 1); glVertex3fv(vertice[3]);
	glEnd();
}
...
void CFiguras::prisma2 (GLuint text, GLuint text2, GLuint text3,GLuint text4) { //Funcion creacion prisma
